VERSION 5.00
Begin VB.Form frm_R利息未払前払明細表 
   BorderStyle     =   3  '固定ﾀﾞｲｱﾛｸﾞ
   Caption         =   "利息未払前払明細表　出力"
   ClientHeight    =   3465
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10455
   ...
   End
End
Attribute VB_Name = "frm_R利息未払前払明細表"
...
Option Explicit
'
Private Const pPROGRAM_ID As String = "frm_R利息未払前払明細表"
'
