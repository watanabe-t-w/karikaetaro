VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RDH030_銀行別利息表 
   Caption         =   "銀行別利息表"
   ClientHeight    =   10950
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   20220
   Icon            =   "RDH030_銀行別利息表.dsx":0000
   StartUpPosition =   3  'Windows の既定値
   WindowState     =   2  '最大化
   _ExtentX        =   35666
   _ExtentY        =   19315
   SectionData     =   "RDH030_銀行別利息表.dsx":0ECA
End
Attribute VB_Name = "RDH030_銀行別利息表"
...
Option Explicit
'杉村倉庫仕様
Private Const pPROGRAM_ID As String = "RDH030_銀行別利息表"
'
Dim wML As Integer
...
'
    ...
    L_帳票名.Caption = Left(GRpt.テキスト_02, 4) & "年" & Right(GRpt.テキスト_02, 2) & "月 " & GRpt.帳票名
...
'
    ...
    If GRpt.詳細表示 = 1 Then
        ...
        Me.GroupHeader1.Controls("L_番号") = "借入番号"
        Me.GroupHeader1.Controls("L_利率").Visible = True
        Me.GroupHeader1.Controls("Line_H1").Visible = True
    Else
        Me.Detail.Height = 0
        Me.GroupHeader1.Controls("L_番号") = "銀行名"
        Me.GroupHeader1.Controls("L_利率").Visible = False
        Me.GroupHeader1.Controls("Line_H1").Visible = False
    End If
'
    '----------------------------------------------------------------
    '                       ** 印字用ファイル作成 **
...
'
    Me.Detail.Controls("I_融資金額") = Format(P8.FCDbl(Me.Detail.Controls("I_融資金額")) / w分母, "#,##0")
...
Private Sub GroupHeader1_BeforePrint()
    If Me.Detail.Controls("I_利息区分") = "利息先払" Then
        Me.GroupHeader1.Controls("L10_利息前残") = "前払利息(洗替+)"
        Me.GroupHeader1.Controls("L10_利息残") = "前払利息(計上額-)"
    Else
        Me.GroupHeader1.Controls("L10_利息前残") = "未払利息(洗替-)"
        Me.GroupHeader1.Controls("L10_利息残") = "未払利息(計上額+)"
    End If
End Sub
...
'
    Me.GroupFooter1.Controls("G10_融資金額") = Format(P8.FCDbl(Me.GroupFooter1.Controls("G10_融資金額")) / w分母, "#,##0")
...
'
    Me.GroupFooter2.Controls("G20_融資金額") = Format(P8.FCDbl(Me.GroupFooter2.Controls("G20_融資金額")) / w分母, "#,##0")
...
'
    Me.GroupFooter3.Controls("G30_融資金額") = Format(P8.FCDbl(Me.GroupFooter3.Controls("G30_融資金額")) / w分母, "#,##0")
...
'
    ...
    Call MXA030_ReportColor(Me.GroupFooter3.Controls("G30_融資残高"))
