...
Option Explicit
'
Private Const pPROGRAM_ID As String = "frm_R借入残高表"
'
...
'
    ...
    Call MFA001_GRrptBunrui("frm_R借入残高表")
'
    入力チェック = True
'
    Exit Function
...
'
    ...
    If Check5 = 0 Then
        GRpt.帳票名 = "借入残高表"
        'Set rpt = New RDF010_借入残高表
        Set rpt = New RDF020_借入残高表
    ElseIf Check5 = 1 Then
        GRpt.帳票名 = "社債残高表"
        Set rpt = New RDF010_社債残高表
    End If
'
    rpt.Show vbModal
'
