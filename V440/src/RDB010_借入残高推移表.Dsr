VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RDB010_借入残高推移表 
   Caption         =   "借入残高推移表"
   ClientHeight    =   8055
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   13290
   Icon            =   "RDB010_借入残高推移表.dsx":0000
   StartUpPosition =   2  '画面の中央
   WindowState     =   2  '最大化
   _ExtentX        =   23442
   _ExtentY        =   14208
   SectionData     =   "RDB010_借入残高推移表.dsx":0ECA
End
Attribute VB_Name = "RDB010_借入残高推移表"
...
Option Explicit
'
Private Const pPROGRAM_ID As String = "RDB010_借入残高推移表"
'
...
Dim G1_D(1, 10, 5) As Double, G2_D(1, 10, 5) As Double, G3_D(1, 10, 5) As Double, G4_D(1, 10, 5) As Double, GT_D(1, 10, 5) As Double '列数
