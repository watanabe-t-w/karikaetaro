VERSION 5.00
Begin VB.Form frm_R借入金時価評価適用金利一覧 
   BorderStyle     =   3  '固定ﾀﾞｲｱﾛｸﾞ
   Caption         =   "借入金時価評価適用金利一覧　出力"
   ClientHeight    =   3405
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10185
   Icon            =   "frm_R借入金時価評価適用金利一覧.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   End
End
Attribute VB_Name = "frm_R借入金時価評価適用金利一覧"
...
Option Explicit
'
Private Const pPROGRAM_ID As String = "frm_R借入金時価評価適用金利一覧"
'
...
'
    ...
    '              レポート表示
    ' =========================================
    Set rpt = New REA020_借入金時価評価適用金利一覧
'
    rpt.Show vbModal
'
    Set rpt = Nothing
