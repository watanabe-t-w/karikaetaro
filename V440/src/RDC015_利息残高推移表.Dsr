VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RDC015_利息残高推移表 
   Caption         =   "利息残高推移表"
   ClientHeight    =   9255
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12525
   Icon            =   "RDC015_利息残高推移表.dsx":0000
   StartUpPosition =   2  '画面の中央
   WindowState     =   2  '最大化
   _ExtentX        =   22093
   _ExtentY        =   16325
   SectionData     =   "RDC015_利息残高推移表.dsx":0ECA
End
Attribute VB_Name = "RDC015_利息残高推移表"
...
Option Explicit
'
Private Const pPROGRAM_ID As String = "RDC015_利息残高推移表"
'
