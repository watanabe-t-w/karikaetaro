...
Begin VB.Form frm_R損益利息一覧表 
   ...
   End
End
Attribute VB_Name = "frm_R損益利息一覧表"
...
Option Explicit
'
Private Const pPROGRAM_ID As String = "frm_R損益利息一覧表"
'
...
'
    ...
    Call MFA001_GRrptBunrui("frm_R損益利息一覧表")
'
    入力チェック = True
'
    Exit Function
