VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RDC020_利息残高推移表 
   Caption         =   "利息残高推移表"
   ClientHeight    =   10935
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   17100
   Icon            =   "RDC020_利息残高推移表.dsx":0000
   StartUpPosition =   2  '画面の中央
   WindowState     =   2  '最大化
   _ExtentX        =   30163
   _ExtentY        =   19288
   SectionData     =   "RDC020_利息残高推移表.dsx":0ECA
End
Attribute VB_Name = "RDC020_利息残高推移表"
...
Option Explicit
'
Private Const pPROGRAM_ID As String = "RDC020_利息残高推移表"
'
