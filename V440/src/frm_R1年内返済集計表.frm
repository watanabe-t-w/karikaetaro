...
Begin VB.Form frm_R1年内返済集計表 
   ...
   End
End
Attribute VB_Name = "frm_R1年内返済集計表"
...
'
'杉本倉庫仕様
Private Const pPROGRAM_ID As String = "frm_R1年内返済集計表"
'
...
'
    ...
    Call MFA001_GRrptBunrui("frm_R1年内返済集計表")
'
    入力チェック = True
'
    Exit Function
