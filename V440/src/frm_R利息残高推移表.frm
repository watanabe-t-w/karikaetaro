...
Begin VB.Form frm_R利息残高推移表 
   ...
   End
End
Attribute VB_Name = "frm_R利息残高推移表"
...
Option Explicit
'
Private Const pPROGRAM_ID As String = "frm_R利息残高推移表"
'
...
'
    ...
    Call MFA001_GRrptBunrui("frm_R利息残高推移表")
'
    入力チェック = True
'
    Exit Function
...
'
    ...
    If GRpt.推移 = "年次" Or GRpt.推移 = "半期" Then
        Set rpt = New RDC010_利息残高推移表
        '杉村倉庫仕様
        'Set rpt = New RDC015_利息残高推移表
    ElseIf GRpt.推移 = "四半期" Or GRpt.推移 = "月次" Then
        Set rpt = New RDC020_利息残高推移表
        '杉村倉庫仕様
        'Set rpt = New RDC025_利息残高推移表
    End If
'
    rpt.Show vbModal
'
...
'
    ...
    GLogStr = GLogStr & "金利ｼﾐｭﾚｰｼｮﾝ=" & Check5.Value & ","
